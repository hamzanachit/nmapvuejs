  ...
  <div class="flex h-full">
    <aside class="w-64 border-r p-4 hidden lg:block">
      ...
      <nav class="space-y-1">
        ...
        <RouterLink to="/docs/arcs" class="block px-3 py-2 rounded-md text-sm bg-accent">Arcs</RouterLink>
    ...
    <div class="flex-1 p-8">
      <div class="max-w-3xl">
        <h1 class="text-3xl font-bold mb-4">Arcs</h1>
        <p class="text-muted-foreground mb-8">Create curved arc lines between points using Bézier interpolation.</p>
