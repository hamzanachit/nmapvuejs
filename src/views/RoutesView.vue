  ...
  <div class="flex h-full">
    <aside class="w-64 border-r p-4 hidden lg:block">
      ...
      <nav class="space-y-1">
        ...
        <RouterLink to="/docs/routes" class="block px-3 py-2 rounded-md text-sm bg-accent">Routes</RouterLink>
    ...
    <div class="flex-1 p-8">
      <div class="max-w-3xl">
        <h1 class="text-3xl font-bold mb-4">Routes</h1>
        <p class="text-muted-foreground mb-8">Draw routes and paths on your maps with customizable styling.</p>
        
        <div class="rounded-xl border overflow-hidden mb-8">
          <div class="h-[400px]">
            <Map :center="[77.209, 28.6139]" :zoom="10" />
          </div>
        </div>
      </div>
    </div>
