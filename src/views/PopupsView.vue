  ...
  <div class="flex h-full">
    <aside class="w-64 border-r p-4 hidden lg:block">
      ...
      <nav class="space-y-1">
        ...
        <RouterLink to="/docs/popups" class="block px-3 py-2 rounded-md text-sm bg-accent">Popups</RouterLink>
    ...
    <div class="flex-1 p-8">
      <div class="max-w-3xl">
        <h1 class="text-3xl font-bold mb-4">Popups</h1>
        <p class="text-muted-foreground mb-8">Display popups when users interact with markers.</p>
